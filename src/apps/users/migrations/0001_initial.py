    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('investor_type', models.CharField(blank=True, choices=[('CONSERVATIVE', 'Conservative'), ('MODERATE', 'Moderate'), ('INTERMEDIATE', 'Intermediate'), ('AGGRESSIVE', 'Aggressive'), ('HIGH_RISK', 'High Risk')], default='', max_length=20)),
                ('preferred_currency', models.CharField(choices=[('KES', 'Kenyan Shilling'), ('USD', 'US Dollar')], default='KES', max_length=3)),
